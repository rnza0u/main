...
For issues and bugs, please make sure to use [our issue tracker](https://github.com/Hakhenaton/main/issues).
...
It is written with ❤️ in [Rust](https://www.rust-lang.org) and is [**absolutely free**](https://github.com/Hakhenaton/main/blaze/LICENCE) to use.
...
- Parallelization
- Support for JSON, YAML and Jsonnet
