...
<BrowserOnly>{
  () => <WithLatestVersion>{
      version => <>
        <p>
          You can install your own binary <a target="_blank" href={`https://github.com/Hakhenaton/main/tree/blaze-${version}`}>from the source code</a> using different methods.
        </p>
